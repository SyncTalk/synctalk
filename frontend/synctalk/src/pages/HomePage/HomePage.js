    ...
    <div>
      ...
      <div className="home-container">
        <div className="home-intro">
          SyncTalk empowers language learners by seamlessly aligning audio,
          transcriptions, and translations. Enhance your language skills
          effortlessly.
        </div>
      </div>
      <div className="example">
        <div onClick={() => playAudio("en")}>
          Hello
          <img src={soundImage} alt="sound icon" />
        </div>
        <div onClick={() => playAudio("fr")}>
          Bonjour
          <img src={soundImage} alt="sound icon" />
        </div>
        <div onClick={() => playAudio("zh")}>
          你好
          <img src={soundImage} alt="sound icon" />
        </div>
      </div>
